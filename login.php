    ...
    <div class="main">
        ...
        <div class="content">
            <div class="card">
                ...
                <?php } else { ?>
                <h1>Login</h1>
                <h5 class="warning">Note: If you are logging in as an admin for the first time and your account was
                    created by
                    another admin, you
                    can ignore the "Password" field for now.</h5>
                <form action="include/login.include.php" method="POST">
                    <table>
                        <tr>
                            <td><label class="label" for="username" id="username">Username</label></td>
                            <td>
                                <input class="box username" type="text" name="username" id="username" required>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input class="box" type="password" name="password" id="password"></td>
                        </tr>
                    </table>
                    <button class="pagebtn" type="submit">Login</button>
                </form>
                <?php } ?>
            </div>
        </div>

    ...
    <div class="main">
        ...
        <div class="content">
            <div class="card">
                ...
                <form action="../include/create-request.include.php" method="POST">
                    <table>
                        <tr>
                            ...
                            <td>
                                <textarea class="box area" name="details" id="details" cols="30" rows="10"
                                    placeholder="Enter request details here..." required></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input class="box" type="number" name="target" min="1"
                                    placeholder="Enter target amount here..." required>
                            </td>
                        </tr>

        ...
        <div class="content">
            <div class="card">
                ...
                <?php
                    ...
                    $select = mysqli_query($conn, "SELECT * FROM requests WHERE ngo='$ngo' AND stype='2' ORDER BY time DESC");
                    if (!mysqli_num_rows($select)) { ?>
                <h2>You do not have any rejected request</h2>
                <?php } else { ?>
                <h1>Your Rejected Requests</h1>
                <table class="list">
                    <tr>
                        <th>Details</th>
                        <th>Target (USD)</th>
                    ...
                    <tr>
                        ...
                        <td><a href="edit-request.ngo.php?id=<?php echo $result['id']; ?>"><button
                                    class="pagebtn tblbtn">Edit</button></a></td>
                        <td><a href="../include/delete-request.include.php?id=<?php echo $result['id']; ?>"><button
                                    class="pagebtn tblbtn">Delete</button></a></td>
                    </tr>
                    <?php } ?>
                </table>
                <?php }

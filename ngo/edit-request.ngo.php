    ...
    <div class="main">
        ...
        <div class="content">
            <div class="card">
                ...
                <?php } else { ?>
                <h1>Edit Request</h1>
                <form action="../include/edit-request.include.php" method="POST">
                    <table>
                        <tr>
                            <td><label class="label" for="details" id="details">Request Details</label></td>
                            <td>
                                <textarea class="box area" name="details" id="details" cols="30" rows="10"
                        ...
                        <tr>
                            <td>
                                <label class="label" for="target" id="target">Target (USD)</label>
                            </td>
                            <td><input class="box" type="number" name="target" min="1"
                                    placeholder="Enter target amount here..." value="<?php echo $result['target']; ?>"
                                    required>
                            </td>
                        </tr>
                    </table>
                    <input type="hidden" name="id" value="<?php echo $result['id']; ?>">
                    <button class="pagebtn" type="submit">Update</button>
                </form>
                <?php } ?>
            </div>
        </div>

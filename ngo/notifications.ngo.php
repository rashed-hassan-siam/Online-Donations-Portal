        ...
        <div class="content">
            <div class="card">
                ...
                <?php
                    ...
                    $select = mysqli_query($conn, "SELECT * FROM requests WHERE ngo='$ngo' AND stype='3' ORDER BY notify DESC");
                    if (!mysqli_num_rows($select)) { ?>
                <h2>You do not have any notification yet</h2>
                <?php } else { ?>
                <h1>Notifications</h1>
                <h2>Your following requests have reached their targets</h2>
                <table class="list">
                    <tr>
                        <th>Details</th>
                        <th>Target (USD)</th>
                    ...
                    <tr>
                        ...
                        <td><?php echo $result['notify']; ?></td>
                        <td><a href="../include/notifications.include.php?id=<?php echo $result['id']; ?>"><button
                                    class="pagebtn tblbtn">Withdraw</button></a></td>
                    </tr>
                    <?php } ?>
                </table>
                <?php }

    ...
    <div class="main">
        ...
        <div class="content">
            <div class="card">
                ...
                <p class="paragraph">
                    New Hope Organization is a charitable web application. Anybody who is capable can create an
                    account and start donating right away. Also if anyone is looking for donations on behalf of any NGO,
                    they can submit their requests here too.<b> All of the transactions that occur throughout this
                        application is completely confidential. We assure you that none of your data nor credentials are
                        send anywhere out. Our application ensures the privacy of each and every user.</b> We currently
                    support four online banking services, they are, Bkash and Nagad for users inside Bangladesh who want
                    to donate in Bangladeshi currency BDT, and also Paypal and Western Union for users who want to
                    donate in USD. All of the donations are finally converted and calculated in USD currency.

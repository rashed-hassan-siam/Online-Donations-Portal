            ...
            <div class="card">
                ...
                <form action="include/signup.include.php" method="POST">
                    <table>
                        ...
                        <tr>
                            <td><label class="label" for="email" id="email">Email</label></td>
                            <td>
                                <input class="box" type="text" name="email" required>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label class="label" for="password" id="password">Password</label>
                            </td>
                            <td><input class="box" type="password" name="password" required>
                            </td>
                        </tr>
                        <tr>
                            <td><label class="label" for="role" id="role">Sign Up As</label></td>
                            <td>
                                <input type="radio" id="donor" name="role" value="3" required>
                                <label class="label" for="donor">Donor</label>
                                <input type="radio" id="ngo" name="role" value="2" required>
                                <label class="label" for="ngo">NGO Member</label>
                            </td>
                        </tr>
                    </table>
                    <button class="pagebtn" type="submit">Sign Up</button>
                </form>
                <?php } ?>
            </div>
        </div>

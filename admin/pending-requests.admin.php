    ...
    <div class="main">
        ...
        <div class="content">
            <div class="card">
                ...
                <?php } else { ?>
                <?php
                    $select = mysqli_query($conn, "SELECT * FROM requests WHERE stype='0' ORDER BY time DESC");
                ...
                <table class="list">
                    ...
                    <tr>
                        ...
                        <td><a href="../include/accept-request.include.php?id=<?php echo $result['id']; ?>"><button
                                    class="pagebtn tblbtn">Accept</button></a></td>
                        <td><a href="reject-request.admin.php?id=<?php echo $result['id']; ?>"><button

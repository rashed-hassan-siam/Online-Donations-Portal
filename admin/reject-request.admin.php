    ...
    <div class="main">
        ...
        <div class="content">
            <div class="card">
                ...
                <form action="../include/reject-request.include.php" method="POST">
                    <table>
                        <tr>
                            <td><label class="label" for="reason" id="reason">Rejection Reason</label></td>
                        </tr>
                        <tr>
                            <td>
                                <textarea class="box area" name="reason" id="reason" cols="30" rows="10"
                                    placeholder="Enter rejection reason here..." required></textarea>
                            </td>
                        </tr>
                    </table>
                    <input type="hidden" name="id" value="<?php echo $result['id']; ?>">
                    <button class="pagebtn" type="submit">Reject</button>
                </form>
                <?php } ?>
            </div>
        </div>
